...
tvShows.forEach((show) => console.log(show)); // <= arrow function, for each iterates once for every element in the array,
// plugs each element into the show parameter and then prints
